...
package jmeducationplatform.javaCore.block4.task418;
...
public class Task418 {
    ...
    public static String getCallerClassAndMethodName() {
        StackTraceElement[] ste = new Throwable().getStackTrace();   // или Thread.currentThread().getStackTrace();

        if (ste.length < 3) {     // <4
            return null;
        } else {
            return ste[2].getClassName() + "#" + ste[2].getMethodName();    // ste[3]
        }
    }
}
